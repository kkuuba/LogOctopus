...
remote_device_incorrect_ip_config_path = "backend/config/remote_device_incorrect_ip_config.jsonn"
...
def copy_test_configs():
    ...
    shutil.copy("tests/test_device_configs/remote_device_incorrect_ip_config.json", remote_device_incorrect_ip_config_path)
    yield
    os.remove(remote_device_config_path)
    os.remove(local_device_config_path)
    os.remove(local_incorrect_device_config_path)
    os.remove(remote_device_incorrect_ip_config_path)
